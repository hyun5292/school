					...
					<table class="table table-hover" style="width: 90%;">
						<thead align="center">
							<tr>
								...
								<td width="30%" style="background-color: #337ab7; color: White;">계정종류</td>
								<td width="30%" style="background-color: #337ab7; color: White;">외부
									사이트 명</td>
								<td width="15%" style="background-color: #337ab7; color: White;">날짜</td>
						...
						<tbody style="color: Black;">
							<c:forEach items="${dtos}" var="dto">
								<tr>
									...
									<td align="center">${dto.getL_YEAR()}-${dto.getL_MONTH()}-${dto.getL_DAY()} ${dto.getL_HOUR()}:${dto.getL_MINUTE()}</td>
									<td align="center">${dto.getL_ACTIVITY()}</td>
								</tr>
							</c:forEach>
						</tbody>
						<tfoot>
